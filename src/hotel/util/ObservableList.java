...
public class ObservableList<T> implements List<T> {
    ...
    public boolean remove(Object element) {
        ...
        elementRemoved.notifyObservers((T)element);
        return result;
    }
    ...
    public boolean removeAll(Collection<?> c) {
        ...
        for (Object o : c) {
            if (data.contains(o)) {
                data.remove(o);
                elementRemoved.notifyObservers((T)o);
                listChanged = true;
            }
        }
    ...
    public void AddElementAddedListener(Observer<T> observer) {
        elementAdded.addObserver(observer);
    }

    public void AddElementRemovedListener(Observer<T> observer) {
    ...
    private List<T> data;
    private ConcreteObservable<T> elementAdded = new ConcreteObservable<T>();
    private ConcreteObservable<T> elementRemoved = new ConcreteObservable<T>();
}
